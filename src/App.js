...
import { useBodyBoundaries } from './hooks/useBodyBoundaries'
...
function App() {
  const bodyBoundaries = useBodyBoundaries()
  const [playState, sendMSG,webSocket] = useWebSocket(ws, bodyBoundaries)
